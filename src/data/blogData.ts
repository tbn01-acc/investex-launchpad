...
Помните: fundraising — это sales process. Вы продаете vision и equity. И как в любых продажах, preparation и execution определяют результат.`,
  ...
  },
  {
    ...
    author: blogAuthors[1],
    category: 'scaling',
    tags: ['соответствие продукта рынку', 'валидация', 'метрики'],
  ...
  },
  {
    ...
    author: blogAuthors[2],
    category: 'series-a',
    tags: ['венчур', 'процесс', 'инвестиции'],
  ...
  },
  {
    ...
    author: blogAuthors[3],
    category: 'scaling',
    tags: ['выход на рынок', 'B2B', 'стратегия'],
  ...
  // Developers Articles
  {
    ...
    category: 'seed-funding',
    tags: ['МВП', 'архитектура', 'разработка'],
