  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white hover:shadow-glow hover:scale-105 transition-bounce border-0 font-semibold",
        premium: "bg-gradient-secondary text-white hover:shadow-elegant hover:scale-105 transition-bounce border-0",
        investment: "bg-investment-green text-white hover:bg-investment-green/90 shadow-card",
        fintech: "bg-fintech-blue text-white hover:bg-fintech-blue/90 shadow-card",
      },
      size: {
