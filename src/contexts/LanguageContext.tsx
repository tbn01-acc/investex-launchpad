...
const translations = {
  ru: {
    ...
    'breadcrumb.franchisee': 'Франчайзи',
    'breadcrumb.new': 'Создать',
    'breadcrumb.blog': 'Блог',
    'breadcrumb.consultants': 'Консультантам',
    'breadcrumb.experts': 'Экспертам',
    'breadcrumb.bloggers': 'Блогерам',
    'breadcrumb.ambassadors': 'Амбассадорам',
    'breadcrumb.jobseekers': 'Соискателям',
    'breadcrumb.jobSeekers': 'Соискателям',
    'breadcrumb.copartners': 'Ко-партнерам',
    'breadcrumb.coPartners': 'Ко-партнерам',
    'breadcrumb.franchisees': 'Франчайзи',
    'breadcrumb.franchisers': 'Франчайзерам',
    'breadcrumb.administrators': 'Администраторам',
    'breadcrumb.collectiveInvestors': 'Коллективным инвесторам',
    'breadcrumb.projectAdmins': 'Админам проектов',
    'breadcrumb.coFounders': 'Ко-фаундерам',
    'breadcrumb.coInvestors': 'Соинвесторам',
    'breadcrumb.contractors': 'Подрядчикам',
    'breadcrumb.community': 'Сообщество',
    'breadcrumb.favorites': 'Избранное',
    'breadcrumb.investmentStartups': 'Инвестиционные стартапы',
    'breadcrumb.ideaExchange': 'Биржа идей',
    'breadcrumb.secondaryMarket': 'Вторичный рынок',
    'breadcrumb.iviIndex': 'IVI Индекс',
    'breadcrumb.supervisoryBoard': 'Наблюдательный совет',
    'breadcrumb.mediationCenter': 'Центр медиации',
  ...
  en: {
    ...
    'breadcrumb.franchisee': 'Franchisee',
    'breadcrumb.new': 'Create',
    'breadcrumb.blog': 'Blog',
    'breadcrumb.consultants': 'For Consultants',
    'breadcrumb.experts': 'For Experts',
    'breadcrumb.bloggers': 'For Bloggers',
    'breadcrumb.ambassadors': 'For Ambassadors',
    'breadcrumb.jobseekers': 'For Job Seekers',
    'breadcrumb.jobSeekers': 'For Job Seekers',
    'breadcrumb.copartners': 'For Co-Partners',
    'breadcrumb.coPartners': 'For Co-Partners',
    'breadcrumb.franchisees': 'For Franchisees',
    'breadcrumb.franchisers': 'For Franchisers',
    'breadcrumb.administrators': 'For Administrators',
    'breadcrumb.collectiveInvestors': 'For Collective Investors',
    'breadcrumb.projectAdmins': 'For Project Admins',
    'breadcrumb.coFounders': 'For Co-Founders',
    'breadcrumb.coInvestors': 'For Co-Investors',
    'breadcrumb.contractors': 'For Contractors',
    'breadcrumb.community': 'Community',
    'breadcrumb.favorites': 'Favorites',
    'breadcrumb.investmentStartups': 'Investment Startups',
    'breadcrumb.ideaExchange': 'Idea Exchange',
    'breadcrumb.secondaryMarket': 'Secondary Market',
    'breadcrumb.iviIndex': 'IVI Index',
    'breadcrumb.supervisoryBoard': 'Supervisory Board',
    'breadcrumb.mediationCenter': 'Mediation Center',
