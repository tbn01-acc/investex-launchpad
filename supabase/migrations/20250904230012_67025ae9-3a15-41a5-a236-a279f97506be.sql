-- Создание enum для методов регистрации (если не существует)
DO $$ BEGIN
...
-- Обновление enum user_role с новыми значениями
...
-- Политики для password_reset_requests
DROP POLICY IF EXISTS "System can manage password reset requests" ON password_reset_requests;
