...
- [ ] 1.1 Создать enum UserRole с 8 основными ролями
- [ ] 1.2 Обновить таблицу profiles с новыми ролями
- [ ] 1.3 Создать таблицу user_roles для множественных ролей
- [ ] 1.4 Создать таблицу organization_types
- [ ] 1.5 Создать таблицу registration_methods
...
- [ ] 1.19 Создать таблицу password_reset_requests
- [ ] 1.20 Добавить индексы для оптимизации запросов
- [ ] 1.21 Настроить автоочистку устаревших токенов

### Backend для восстановления пароля
- [ ] 1.22 Создать edge function для запроса восстановления пароля
